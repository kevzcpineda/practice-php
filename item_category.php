...
<body>
    <?php
        $page = 'category';
        include("connect.php");
        $selectUsers = "SELECT * FROM item_category ORDER BY id DESC";
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="add_item_category.php" method="POST">
                <div class="modal-body">
                    <label >Item category</label>
                    <span id="product_error"></span>   
                    <input type="text" name="item_category" id="item_category" placeholder="Item category"><br>  
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="edit_category" id="edit_category"><br>                  
            </div>
            <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="delete_item_category.php" method="POST">
            <div class="modal-body">

<?php
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-01-01' AND date<='".$year_now."-01-31' AND category='$selected_category'";
    ...
    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-01-01' AND date<='".$year_now."-01-31' AND category='$selected_category'";
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-02-01' AND date<='".$year_now."-02-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-02-01' AND date<='".$year_now."-02-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-03-01' AND date<='".$year_now."-03-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-03-01' AND date<='".$year_now."-03-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-04-01' AND date<='".$year_now."-04-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-04-01' AND date<='".$year_now."-04-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-05-01' AND date<='".$year_now."-05-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-05-01' AND date<='".$year_now."-05-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-06-01' AND date<='".$year_now."-06-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-06-01' AND date<='".$year_now."-06-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-07-01' AND date<='".$year_now."-07-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-07-01' AND date<='".$year_now."-07-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-08-01' AND date<='".$year_now."-08-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-08-01' AND date<='".$year_now."-08-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-09-01' AND date<='".$year_now."-09-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-09-01' AND date<='".$year_now."-09-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-10-01' AND date<='".$year_now."-10-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-10-01' AND date<='".$year_now."-10-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
    ...
    $monthly_capital_sql = "SELECT * FROM add_quantity WHERE date>='".$year_now."-11-01' AND date<='".$year_now."-11-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_capital_sql);
    $monthly_capital_result = $prepareStatement->execute();
    $monthly_capital_records = $prepareStatement->fetchAll();

    $monthly_sale_sql = "SELECT * FROM sale_record WHERE date>='".$year_now."-11-01' AND date<='".$year_now."-11-31' AND category='$selected_category'";
    $prepareStatement = $con->prepare($monthly_sale_sql);
    $monthly_sales_result = $prepareStatement->execute();
    $monthly_sale_records = $prepareStatement->fetchAll();
